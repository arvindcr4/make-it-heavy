from agent import ZenMuxAgent

def main():
    """Main entry point for the ZenMux agent"""
    print("ZenMux Agent with DuckDuckGo Search")
    ...
    try:
        ...
        print(f"Using model: {agent.config['zenmux']['model']}")
